...
defect_classes = ['BW','CS', 'CH', 'JB', 'QT', 'QJ', 'QW','SW','TCHJ','TCHS','YW','ZF','ZC']

def single_classify(path):
    tf.reset_default_graph()#fanfu diaoyong
    ...
    saver.restore(sess, 'D:/Python/fifth/static/fenlei/checkpoint/20_3000resnet_2000.ckpt')
...
# result = single_classify('/home/xdjf/end_llhj/crop/0.jpg')
# print(result)
