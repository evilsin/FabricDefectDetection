...
!function (e) {
    ...
    var H;
    t.amd = {};
    var Q = /require\(\s*(['"'])([^'"]+)\1\s*\)/g, G = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm, J = 0, K = 1, V = 2,
        W = 0, X = 1, Y = 2, Z = {}, er = {require: r, exports: 1, module: 1}, rr = [], nr = {},
        tr = {baseUrl: "./", paths: {}, config: {}, map: {}, packages: [], waitSeconds: 0, urlArgs: {}};
    r.config = function (e) {
    ...
    var ir, ar, or, ur, sr, cr, fr, dr = /^[-_a-z0-9\.]+(\/[-_a-z0-9\.]+)*$/i,
        vr = document.getElementsByTagName("head")[0], lr = document.getElementsByTagName("base")[0];
